...
public abstract class AbstractCommentSetter<NodeLabel extends Enum<NodeLabel>> extends AbstractNodeSetter<NodeLabel> {
	...
	public AbstractCommentSetter(IUserAuthorization authorizationLEvel, NodeLabel nodeLabel,INodePropertyKey refKey,
	...
	public void create()
	{
		...
		_currentNode=GraphNode.create(_nodeLabel);

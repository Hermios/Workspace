...
public abstract class AbstractNodeGetter<NodeLabel extends Enum<NodeLabel>> extends AbstractNodeGetSet<NodeLabel> implements IGetter{	
	
	protected AbstractNodeGetter(IUserAuthorization authorizationLevel,
			NodeLabel nodeLabel, INodePropertyKey refKey,
			SessionAttributeKeys sessionAttributeKey) {
		super(nodeLabel,authorizationLevel, refKey, sessionAttributeKey);
	}

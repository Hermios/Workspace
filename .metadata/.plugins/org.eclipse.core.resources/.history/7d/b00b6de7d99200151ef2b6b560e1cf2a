...
public class GetDataHelper {
	public static void doGet(HttpServletRequest request, HttpServletResponse response,int userAuthorizationLevel) throws InstantiationException, IllegalAccessException
	{
		...
		try 
		{
			...
			if(getter.getAuthorizationLevel()>userAuthorizationLevel)

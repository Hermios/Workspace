...
public abstract class ServletFilter extends HttpServlet{	
	...
	{			
		...
		setStaticImage(request,isLocalRequest,contentType,response);
	}		
	...
	private void setStaticImage(HttpServletRequest request, boolean isLocalRequest, String contentType, HttpServletResponse response)
	{
		String path="";
	...
	protected abstract String getDynamicPath();
}